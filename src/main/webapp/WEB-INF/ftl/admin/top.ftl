...
<body style="background-color:transparent;">
	<div class="header clearfix">
		...
		<div class="function-block action-block">
			<ul class="action-list">
				<#-- <li class="action-item" id="action-user-nums">
				...
				<li class="action-item" id="btn-show-user-list">
					...
					<span class="action-more-icon" title=""><span>${(login_info.realname)!}</span><b class="action-more-icon-arrow"></b></span>
				</li>
				<#-- <li class="action-item" id="btn-show-more-list">
					<div class="action-more"></div>
					<span class="action-more-icon"><span>更多</span><b class="action-more-icon-arrow"></b></span>
				</li> -->
			</ul>
		</div>
	</div>
	<ul class="top-list hide" id="user-top-list">
		...
		<li class="top-list-item">
			<i class="iconfont">&#xe641;</i>
			<a href="${contextPath}/user/password.do" target="contentFrame">修改密码</a>
		</li>
		<li class="top-list-item">
			<i class="iconfont">&#xe642;</i>
			<a href="${contextPath}/user/logout.do">退出登录</a>
		</li>
		<#-- <li class="top-list-item">
			<i class="iconfont">&#xe642;</i>
			<a href="##">更多下拉</a>
