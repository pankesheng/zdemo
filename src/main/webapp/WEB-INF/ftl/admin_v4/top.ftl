...
<body>
    <div class="header clearfix">
        <div class="function-block">
            <p class="function-list">
                ...
                <a class="split" href="${contextPath}/user4/password.do" target="contentFrame">修改密码</a>
                <a class="split" href="${contextPath}/index4/container.do" target="contentFrame">首页</a>
    ...
    <!--[if lt IE 8]>
    <script type="text/javascript" src="${contextPath}/admin4/ext/jquery/jquery.pngFix.js"></script>
    <script>
        //修复IE6 PNG
        var fixpng = function(){
            $(document).pngFix();
    ...
    <script>
        ...
        $(function(){
            ...
            $('#iconBar').zwbam('initTopMenu', '${contextPath}/index4/menutop.ajax?t=<@z.z_now />');
        });
