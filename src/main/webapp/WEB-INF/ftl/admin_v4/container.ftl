...
<body>
    <iframe class="left-iframe" src="${contextPath}/index4/left.do" scrolling="yes" noresize="noresize" frameborder="0"></iframe>
    <div class="main">
        <!-- 没有面包屑时添加 no-place -->
        <div class="content-wrap">
            <iframe class="content" src="${contextPath}/index4/start.do" name="rightFrame" id="rightFrame" frameborder="0" title="rightFrame" ></iframe>
        </div>
        <!-- 左侧折叠按钮 不需要请删除 -->
