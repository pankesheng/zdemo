...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="<%=request.getContextPath() %>/admin/stylesheets/common.css" />
    <link rel="stylesheet" href="<%=request.getContextPath() %>/admin/stylesheets/login.css" />
