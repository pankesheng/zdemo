...
!(function ($) {
	...
	var Grid = function ($dom, config) {
		...
		this.defaults = {
			...
			tool: {
				//ADD 户用选择视图面板
				enablePanelViewport: false,
				panelViewportTitle: null,
	...
	Grid.prototype.generateTableRow = function (rowData, rowIndex) {
		...
		if (this.opts.tool.checkboxSelect) {
			$tr.append('<td><input class="checkbox" type="checkbox" data-rowIndex=' + rowIndex + ' /></td>');
		}
		//渲染序号
	...
	Grid.prototype.initTool = function () {
		...
		/*面板视图*/
		if (this.opts.tool.enablePanelViewport) {
			var createPanelHtml = '<div class="panel panel-viewport"><div class="panel-viewport-title">您目前的选择:</div><ul class="clearfix"><li class="panel-viewport-item" data-value="2"><span>我是很长的一个字符串</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li><li class="panel-viewport-item" data-value="2"><span>莫胜利</span><i class="iconfont remove-option"></i></li></ul></div><div class="panel table-tool-bar"><a id="confirm-btn" class="btn" href="javascript:void(0);"><i class="add-btn iconfont"></i>确定</a><a id="cancel-btn" class="btn" href="javascript:void(0);"><i class="remove-btn iconfont"></i>取消</a></div>';
			this.$wrapper.prepend(createPanelHtml)
		...
		var listeners = {
			...
			checkbox: function () {
				...
				me.$me.on('change', ':checkbox:not(.selectAll)', function () {
					...
					//add 面板增加项
					var dataPanelItem = me.gridObj.getRowDataByIndex(parseInt($(this).attr("data-rowIndex")));
					var createPanelItemHtml = '<li class="panel-viewport-item" data-rowIndex="' + dataPanelItem.rowIndex + '"><span>' + dataPanelItem.data[] + '</span><i class="iconfont remove-option"></i></li>';
					console.log()
				});
			},
			//分页
