...
@Scope("prototype")
@Component("index4Action")
public class IndexV4Action extends BasicAction {

	@RequestMapping("/index")
	public String index(HttpServletRequest request, Model model) {
		return "/WEB-INF/ftl/admin_v4/index.ftl";
	}

	@RequestMapping("/top")
	public String top(Model model) {
		return "/WEB-INF/ftl/admin_v4/top.ftl";
	}

	@RequestMapping("/container")
	public String container(Model model) {
		return "/WEB-INF/ftl/admin_v4/container.ftl";
	}

	@RequestMapping("/left")
	public String left(Model model) {
		return "/WEB-INF/ftl/admin_v4/left.ftl";
	}

	@RequestMapping("/start")
	public String start(Model model) {
		return "/WEB-INF/ftl/admin_v4/start.ftl";
	}
	...
	public void menu(HttpServletRequest request, PrintWriter out) {
		...
		MenuDto m31 = new MenuDto("账号管理", Configuration.getContextPath() + "/user4/tolist.do");
		MenuDto m32 = new MenuDto("参数设置", Configuration.getContextPath() + "/user4/tolist.do");
	...
	public void menutop(HttpServletRequest request, PrintWriter out) {
		...
		MenuDto m1 = new MenuDto("应用1", Configuration.getContextPath() + "/admin4/images/icon/icon1.png", "http://www.baidu.com/");
		MenuDto m2 = new MenuDto("应用2", Configuration.getContextPath() + "/admin4/images/icon/icon2.png", "http://www.baidu.com/");
		MenuDto m3 = new MenuDto("应用3", Configuration.getContextPath() + "/admin4/images/icon/icon3.png", "http://www.baidu.com/");
